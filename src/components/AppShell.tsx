...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#fbfaff] text-[#363142]">
      ...
      <nav className="fixed inset-x-3 bottom-3 z-30 mx-auto max-w-4xl rounded-2xl border border-[#ece7fb] bg-white/95 px-3 py-2 shadow-[0_12px_28px_rgba(126,112,174,0.16)] backdrop-blur lg:hidden">
